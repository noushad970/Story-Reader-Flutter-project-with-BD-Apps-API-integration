...
class AppTheme {
  ...
  // DARK COLOR TOKENS
  // ===========================================================
  static const Color darkBackground = Color(0xFF14132B);
  static const Color darkSurface = Color(0xFF1E1C3A);
  static const Color darkSurfaceVariant = Color(0xFF2A2750);
  static const Color darkTextPrimary = Color(0xFFEAE7FF);
  static const Color darkTextSecondary = Color(0xFFB0AED1);
  static const Color darkDivider = Color(0xFF34305A);

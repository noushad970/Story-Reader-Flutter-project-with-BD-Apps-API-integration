...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
  ...
  Future<void> verifyOtp() async {
    // Strip everything that isn't a digit, then trim.
    // Android SMS autofill / paste / hardware keyboard sometimes inserts
    // spaces or newlines, which used to leak to the server and caused
    // "no otp given" replies.
    ...
    if (otp.length < 4 || otp.length > 6) {
      showMessage('OTP must be 4 to 6 digits');
      return;
    }
